...
const sections: Section[] = [
  // Basic
  { step: "Basic", title: "Python & Ecosystem", items: ["Syntax", "Data structures", "Pandas", "NumPy", "Matplotlib", "Seaborn", "Jupyter"] },
  { step: "Basic", title: "Statistics & Probability", items: ["Descriptive stats", "Distributions", "Sampling", "Hypothesis testing", "Confidence intervals"] },
  { step: "Basic", title: "SQL & Data Access", items: ["SELECT/WHERE/JOIN", "Aggregations", "Window functions", "Indexes", "Query optimization basics"] },
  { step: "Basic", title: "EDA & Cleaning", items: ["Missing data", "Outliers", "Data types", "Feature scaling", "Encoding categoricals"] },
  { step: "Basic", title: "Intro ML for DS", items: ["Regression", "Classification", "Clustering", "Train/Test split", "Cross-validation", "Metrics"] },

  // Intermediate
  { step: "Intermediate", title: "Feature Engineering", items: ["Text/date/geo features", "Target encoding", "Pipelines"] },
  { step: "Intermediate", title: "Time Series", items: ["Stationarity", "ARIMA/SARIMA", "Exponential smoothing", "Feature lags"] },
  { step: "Intermediate", title: "Visualization", items: ["Storytelling", "Seaborn advanced", "Plotly/Altair", "Dashboards (Streamlit) "] },
  { step: "Intermediate", title: "Modeling Toolkit", items: ["Tree models", "Ensembles", "SVM", "Naive Bayes", "Hyperparameter tuning"] },
  { step: "Intermediate", title: "Data at Scale", items: ["Spark basics", "Dask/Polars", "Parquet/Arrow", "ETL basics"] },

  // Advanced
  { step: "Advanced", title: "NLP & CV for DS", items: ["Tokenization", "Embeddings", "Transformers for DS", "Classical CV", "Transfer learning"] },
  { step: "Advanced", title: "Causal Inference & Experimentation", items: ["AB testing", "Uplift modeling", "DoWhy intro", "Bias/variance in experiments"] },
  { step: "Advanced", title: "MLOps for DS", items: ["Tracking (MLflow)", "Model registry", "Batch vs real-time scoring", "Docker", "Deployment options"] },
  { step: "Advanced", title: "Business Impact", items: ["KPIs & metrics", "Dashboards", "Communication", "Presentations", "Stakeholder management"] },
];
      ...
      <div className="relative z-10 px-6 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            From statistics and SQL to machine learning, experimentation, and business impact.
          </p>
        </div>
      </div>
      ...
      <section className="relative mx-auto">
        <div className="relative" style={{ height: `${viewBox.h * 0.8}px` }}>
          ...
          {markers.map((m, idx) => {
            ...
            return (
              <div key={m.id} className="group pointer-events-auto absolute z-20" style={{ left: x - 20, top: y - 20 }}>
