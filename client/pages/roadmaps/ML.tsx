...
const sections: Section[] = [
  // Basic
  { step: "Basic", title: "Python & Tools", items: ["Syntax", "Data structures", "Control flow", "Functions", "venv/conda", "NumPy", "Pandas", "Matplotlib/Seaborn"] },
  { step: "Basic", title: "Math Intuition", items: ["Linear algebra (vectors, matrices)", "Calculus (derivatives, gradients)", "Statistics (mean, var, std)", "Probability basics"] },
  { step: "Basic", title: "Core ML Concepts", items: ["Supervised vs Unsupervised vs RL", "Features/labels", "Training/testing", "Params vs Hyperparams"] },
  { step: "Basic", title: "Workflow & Metrics", items: ["Cleaning missing values", "Encoding", "Scaling", "Over/underfitting", "MAE/MSE/R²", "Accuracy/Precision/Recall/CM"] },
  { step: "Basic", title: "First Algorithms (sklearn)", items: ["Linear Regression", "Logistic Regression", "k-NN", "k-Means"] },

  // Intermediate
  { step: "Intermediate", title: "Feature Engineering", items: ["Polynomial features", "Binning", "Datetime features"] },
  { step: "Intermediate", title: "Dimensionality Reduction", items: ["PCA", "LDA"] },
  { step: "Intermediate", title: "Imbalanced Data", items: ["SMOTE", "Undersampling", "Oversampling"] },
  { step: "Intermediate", title: "Tree & Ensemble Models", items: ["Decision Trees", "Random Forest", "GBM/XGBoost/LightGBM/CatBoost"] },
  { step: "Intermediate", title: "SVM & Naive Bayes", items: ["Max-margin intuition", "Kernels (Linear/RBF)", "Naive Bayes"] },
  { step: "Intermediate", title: "Validation & Tuning", items: ["k-Fold, Stratified k-Fold", "GridSearchCV", "RandomizedSearchCV", "F1, ROC-AUC, Adj. R²"] },
  { step: "Intermediate", title: "Intro to Deep Learning", items: ["Perceptron", "MLPs", "Activations: Sigmoid/Tanh/ReLU", "Backprop", "Optimizers: SGD/Adam/RMSprop", "Loss: CE/MSE", "TensorFlow or PyTorch"] },

  // Advanced
  { step: "Advanced", title: "CNNs", items: ["Convolution, pooling, padding", "LeNet/AlexNet/VGG/ResNet/Inception", "Classification/detection/segmentation"] },
  { step: "Advanced", title: "RNNs", items: ["Sequences, hidden states", "LSTM/GRU", "Time series, text generation"] },
  { step: "Advanced", title: "Transformers", items: ["Attention", "BERT/GPT", "NLP tasks: translation/summarization/QA"] },
  { step: "Advanced", title: "Generative Models", items: ["GANs", "VAEs", "Diffusion"] },
  { step: "Advanced", title: "Reinforcement Learning", items: ["Agent/env/reward/policy", "Q-Learning/DQN/Policy Gradients"] },
  { step: "Advanced", title: "MLOps & Deployment", items: ["APIs (FastAPI/Flask)", "Docker", "MLflow/W&B", "SageMaker/Vertex/Azure ML", "Monitoring: drift"] },
  { step: "Advanced", title: "The Cutting Edge", items: ["Read papers (NeurIPS/ICML/CVPR)", "Contribute to OSS", "Specialize: CV/NLP/RL"] },
];
      ...
      <div className="relative z-10 px-6 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            Learn the ML stack from fundamentals to deep learning, model ops and deployment.
          </p>
        </div>
      </div>
      ...
      <div className="relative z-10 px-6 py-12 mt-20">
        <div className="max-w-6xl mx-auto text-center">
          <div className="text-muted-foreground">
            <p className="mb-2">🚀 Become an ML engineer</p>
